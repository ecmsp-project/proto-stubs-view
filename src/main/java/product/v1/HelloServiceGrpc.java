...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<product.v1.Message.HelloRequest,
      product.v1.Message.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = product.v1.Message.HelloRequest.class,
      responseType = product.v1.Message.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<product.v1.Message.HelloRequest,
      product.v1.Message.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<product.v1.Message.HelloRequest, product.v1.Message.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<product.v1.Message.HelloRequest, product.v1.Message.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  product.v1.Message.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  product.v1.Message.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(product.v1.Message.HelloRequest request,
        io.grpc.stub.StreamObserver<product.v1.Message.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void sayHello(product.v1.Message.HelloRequest request,
        io.grpc.stub.StreamObserver<product.v1.Message.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingV2Stub
    ...
    /**
     */
    public product.v1.Message.HelloResponse sayHello(product.v1.Message.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<product.v1.Message.HelloResponse> sayHello(
        product.v1.Message.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((product.v1.Message.HelloRequest) request,
              (io.grpc.stub.StreamObserver<product.v1.Message.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              product.v1.Message.HelloRequest,
              product.v1.Message.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return product.v1.Message.getDescriptor();
    }
