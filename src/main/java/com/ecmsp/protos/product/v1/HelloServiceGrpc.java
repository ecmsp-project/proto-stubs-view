...
@javax.annotation.Generated(
    ...
    comments = "Source: protos/product/v1/message.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class HelloServiceGrpc {

  private HelloServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "product.v1.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.ecmsp.protos.product.v1.HelloRequest,
      com.ecmsp.protos.product.v1.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.ecmsp.protos.product.v1.HelloRequest.class,
      responseType = com.ecmsp.protos.product.v1.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.ecmsp.protos.product.v1.HelloRequest,
      com.ecmsp.protos.product.v1.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.ecmsp.protos.product.v1.HelloRequest, com.ecmsp.protos.product.v1.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.ecmsp.protos.product.v1.HelloRequest, com.ecmsp.protos.product.v1.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ecmsp.protos.product.v1.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ecmsp.protos.product.v1.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(com.ecmsp.protos.product.v1.HelloRequest request,
        io.grpc.stub.StreamObserver<com.ecmsp.protos.product.v1.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void sayHello(com.ecmsp.protos.product.v1.HelloRequest request,
        io.grpc.stub.StreamObserver<com.ecmsp.protos.product.v1.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingV2Stub
    ...
    /**
     */
    public com.ecmsp.protos.product.v1.HelloResponse sayHello(com.ecmsp.protos.product.v1.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ecmsp.protos.product.v1.HelloResponse> sayHello(
        com.ecmsp.protos.product.v1.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.ecmsp.protos.product.v1.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.ecmsp.protos.product.v1.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.ecmsp.protos.product.v1.HelloRequest,
              com.ecmsp.protos.product.v1.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.ecmsp.protos.product.v1.Message.getDescriptor();
    }
