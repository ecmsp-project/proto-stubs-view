...
public final class CategoryServiceGrpc {
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = com.ecmsp.product.v1.category.v1.CreateCategoryRequest.class,
      responseType = com.ecmsp.product.v1.category.v1.CreateCategoryResponse.class,
  ...
  private static volatile io.grpc.MethodDescriptor<com.ecmsp.product.v1.category.v1.DeleteCategoryRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = com.ecmsp.product.v1.category.v1.DeleteCategoryRequest.class,
      responseType = com.ecmsp.product.v1.category.v1.DeleteCategoryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createCategory(com.ecmsp.product.v1.category.v1.CreateCategoryRequest request,
        io.grpc.stub.StreamObserver<com.ecmsp.product.v1.category.v1.CreateCategoryResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateCategoryMethod(), responseObserver);
    }

    /**
     */
    default void deleteCategory(com.ecmsp.product.v1.category.v1.DeleteCategoryRequest request,
        io.grpc.stub.StreamObserver<com.ecmsp.product.v1.category.v1.DeleteCategoryResponse> responseObserver) {
  ...
  public static final class CategoryServiceStub
    ...
    /**
     */
    public void createCategory(com.ecmsp.product.v1.category.v1.CreateCategoryRequest request,
        io.grpc.stub.StreamObserver<com.ecmsp.product.v1.category.v1.CreateCategoryResponse> responseObserver) {
    ...
    /**
     */
    public void deleteCategory(com.ecmsp.product.v1.category.v1.DeleteCategoryRequest request,
        io.grpc.stub.StreamObserver<com.ecmsp.product.v1.category.v1.DeleteCategoryResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class CategoryServiceBlockingV2Stub
    ...
    /**
     */
    public com.ecmsp.product.v1.category.v1.CreateCategoryResponse createCategory(com.ecmsp.product.v1.category.v1.CreateCategoryRequest request) {
    ...
    /**
     */
    public com.ecmsp.product.v1.category.v1.DeleteCategoryResponse deleteCategory(com.ecmsp.product.v1.category.v1.DeleteCategoryRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CategoryServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ecmsp.product.v1.category.v1.CreateCategoryResponse> createCategory(
        com.ecmsp.product.v1.category.v1.CreateCategoryRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ecmsp.product.v1.category.v1.DeleteCategoryResponse> deleteCategory(
        com.ecmsp.product.v1.category.v1.DeleteCategoryRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final int METHODID_DELETE_CATEGORY = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_CATEGORY:
          serviceImpl.createCategory((com.ecmsp.product.v1.category.v1.CreateCategoryRequest) request,
              (io.grpc.stub.StreamObserver<com.ecmsp.product.v1.category.v1.CreateCategoryResponse>) responseObserver);
          break;
        case METHODID_DELETE_CATEGORY:
          serviceImpl.deleteCategory((com.ecmsp.product.v1.category.v1.DeleteCategoryRequest) request,
              (io.grpc.stub.StreamObserver<com.ecmsp.product.v1.category.v1.DeleteCategoryResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.ecmsp.product.v1.category.v1.CreateCategoryRequest,
              com.ecmsp.product.v1.category.v1.CreateCategoryResponse>(
                service, METHODID_CREATE_CATEGORY)))
        .addMethod(
          getDeleteCategoryMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.ecmsp.product.v1.category.v1.DeleteCategoryRequest,
              com.ecmsp.product.v1.category.v1.DeleteCategoryResponse>(
  ...
  private static abstract class CategoryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.ecmsp.product.v1.category.v1.CategoryServiceProto.getDescriptor();
    }
