...
public interface CreateVariantsReservationResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:product.v1.CreateVariantsReservationResponse)
   ...
   */
  java.util.List<com.ecmsp.product.v1.FailedReservationVariant> 
      getFailedVariantsList();
  /**
   * <code>repeated .product.v1.FailedReservationVariant failed_variants = 4;</code>
   */
  com.ecmsp.product.v1.FailedReservationVariant getFailedVariants(int index);
  /**
   * <code>repeated .product.v1.FailedReservationVariant failed_variants = 4;</code>
   */
   ...
   * <code>repeated .product.v1.FailedReservationVariant failed_variants = 4;</code>
   */
  java.util.List<? extends com.ecmsp.product.v1.FailedReservationVariantOrBuilder> 
      getFailedVariantsOrBuilderList();
  /**
   * <code>repeated .product.v1.FailedReservationVariant failed_variants = 4;</code>
   */
  com.ecmsp.product.v1.FailedReservationVariantOrBuilder getFailedVariantsOrBuilder(
      int index);
}
